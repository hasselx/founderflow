    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center py-12">
          <h1 className="text-2xl font-bold text-foreground mb-2">Error Loading Business Plan</h1>
          <p className="text-muted-foreground">The business plan could not be loaded. Please try again.</p>
        </div>
      </div>
    )
  }
